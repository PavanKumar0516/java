...
public class AccountManagementDaoImp implements IAccountManagementDao {
	...
	{
		map.put(944094835100l, new AccountDetails("pavankumar", 9553017205l, 944094835100l, "Savin", "3-77/2a",
				"srinagar", "hyderabad", "Telangana", "India", 502516, 9005.00));
		map.put(944094835101l, new AccountDetails("rohit", 9553017206l, 944094835101l, "Savings", "3-73/2a",
				"karimnagar", "hyderabad", "Telangana", "India", 502512, 5045.00));
		map.put(944094835102l, new AccountDetails("mahesh", 9553017207l, 944094835102l, "current", "3-72/2a",
				"gandhi nagar", "hyderabad", "Telangana", "India", 502519, 7026.00));
		map.put(944094835103l, new AccountDetails("nagendra", 9553017208l, 944094835103l, "Savings", "3-71/2a",
				"dn colony", "hyderabad", "Telangana", "India", 502513, 6005.00));
		map.put(944094835104l, new AccountDetails("vennu", 9553017209l, 944094835104l, "current", "3-75/2a",
				"vishnupur", "hyderabad", "Telangana", "India", 502515, 15005.00));
	}
	...
	public boolean updateCustomerDetails(AccountDetails accountDetails) {
		...
		case 3:
			if (accountDetails.getCustomerAddress1() != null && accountDetails.getCustomerAddress2() != null
					&& accountDetails.getCity() != null && accountDetails.getState() != null
					&& accountDetails.getCountry() != null && accountDetails.getPincode() != 0) {
